...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Categoria cat8 = new Categoria(null, "pikjoule");
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "manoelmerlin1@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
        Cliente cli2 = new Cliente(null, "Admin", "manoelmerlin@hotmail.com", "59646700080", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
        cli2.setPerfil(Perfil.ADMIN);
        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
        cli2.getTelefones().addAll(Arrays.asList("958401353", "970429566"));

        Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
        Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
        Endereco e3 = new Endereco(null, "Avenida tijolo", "20106", null, "Centro", "3595484", cli2, c2);
